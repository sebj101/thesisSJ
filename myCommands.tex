...
%\newcommand*{\theta13}{\ensuremath{\theta_{13}}\xspace}
%\newcommand*{\theta23}{\ensuremath{\theta_{23}}\xspace}
\newcommand*{\ssthetaij}[2]{\ensuremath{\sin^{2}\theta_{#1 #2}}\xspace}
%\newcommand*{\sstheta13}{\ensuremath{\sin^{2}\theta_{13}}\xspace}
%\newcommand*{\sstheta23}{\ensuremath{\sin^{2}\theta_{23}}\xspace}
