...
Furthermore, for the appearance samples, the different event rates resulting from different neutrino mass hierarchies and values of \dcp are shown, while for the disappearance samples to effect of varying \thetai{23} is shown.
...
In a typical oscillation analysis the compatibility of a particular oscillation parameters is evaluated using a negative log-likelihood ratio,
