...
\begin{figure}
	\begin{minipage}[t]{.5\linewidth}
		\begin{adjustbox}{max totalsize=\linewidth, center}
			\input{files/figures/dune_lbl/fdFhcWithSyst}
		\end{adjustbox} \\
		\begin{adjustbox}{max totalsize=\linewidth, center}
	...
	\begin{minipage}[t]{.5\linewidth}
		\begin{adjustbox}{max totalsize=\linewidth, center}
			\input{files/figures/dune_lbl/fdRhcWithSyst}
		\end{adjustbox} \\
		\begin{adjustbox}{max totalsize=\linewidth, center}
			\input{files/figures/dune_lbl/fdNueRhcWithSyst}
		\end{adjustbox}
	\end{minipage}
	\caption[Event rates for each of the far detector samples]{Event rates for each of the far detector samples. The red band indicates the $\pm1\sigma$ error systematic band in each case. For the \nue event rates, results for different neutrino mass hierarchies and values of \dcp are shown. Top left: \numu disappearance with the beam in FHC mode. Top right: \numu disappearance with the beam in RHC mode. Bottom left: \nue appearance with the beam in FHC mode. Bottom right: \nue appearance with the beam in RHC mode.}
