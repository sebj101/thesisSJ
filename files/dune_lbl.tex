...
\begin{figure}
	...
	\begin{minipage}[t]{.5\linewidth}
		...
		\end{adjustbox}
	\end{minipage}
	\caption[Event rates for each of the far detector samples]{Event rates for each of the far detector samples. The red band indicates the $\pm1\sigma$ error band in each case. For the \nue event rates, results for different neutrino mass hierarchies and values of \dcp are shown.}
