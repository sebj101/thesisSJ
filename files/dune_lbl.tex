...
The flux and cross-section systematics detailed in \citesec{sec:dune_lbl:systs:flux} and \citesec{sec:dune_lbl:systs:xsec} respectively were developed by other DUNE collaborators.
Similarly, the CAFAna package described in \citesec{sec:dune_lbl:sensitivities:cafana} was developed by other members of the DUNE collaboration.
...
A summary of the systematics used in the analysis is shown in \citetab{tab:systSummary}.
...
\begin{table}
	\caption[Summary of systematic uncertainties used in the DUNE long-baseline analysis]{Summary of systematics used in the DUNE long-baseline analysis, with special attention paid to the detector systematics. The flux and cross-section systematics are discussed in more detail in \citesec{sec:dune_lbl:systs:flux} and \citesec{sec:dune_lbl:systs:xsec} respectively. For each systematic (or set of them) the particle or interaction types affected, which detector the systematic affects and whether or not the systematic is incorporated into the ND covariance matrix is tabulated.}
