...
\draw [color=c, fill=c] (11.4,5.13734) rectangle (12.8,6.25877);
...
\draw [c,line width=0.9] (17.556,2.78235) -- (18,2.78235);
\draw [c,line width=0.9] (17.556,3.79163) -- (18,3.79163);
\draw [c,line width=0.9] (17.556,4.80092) -- (18,4.80092);
\draw [c,line width=0.9] (17.556,5.8102) -- (18,5.8102);
\draw [c,line width=0.9] (17.556,6.81948) -- (18,6.81948);
\draw [c,line width=0.9] (17.556,7.82877) -- (18,7.82877);
\draw [c,line width=0.9] (17.556,8.83805) -- (18,8.83805);
\draw [c,line width=0.9] (17.556,9.84733) -- (18,9.84733);
\draw [c,line width=0.9] (17.556,10.8566) -- (18,10.8566);
\draw [c,line width=0.9] (17.556,11.8659) -- (18,11.8659);
\draw [anchor= west] (18.1,1.77307) node[scale=1.52731, color=c, rotate=0]{0};
\draw [anchor= west] (18.1,2.78235) node[scale=1.52731, color=c, rotate=0]{0.1};
\draw [anchor= west] (18.1,3.79163) node[scale=1.52731, color=c, rotate=0]{0.2};
\draw [anchor= west] (18.1,4.80092) node[scale=1.52731, color=c, rotate=0]{0.3};
\draw [anchor= west] (18.1,5.8102) node[scale=1.52731, color=c, rotate=0]{0.4};
\draw [anchor= west] (18.1,6.81948) node[scale=1.52731, color=c, rotate=0]{0.5};
\draw [anchor= west] (18.1,7.82877) node[scale=1.52731, color=c, rotate=0]{0.6};
\draw [anchor= west] (18.1,8.83805) node[scale=1.52731, color=c, rotate=0]{0.7};
\draw [anchor= west] (18.1,9.84733) node[scale=1.52731, color=c, rotate=0]{0.8};
\draw [anchor= west] (18.1,10.8566) node[scale=1.52731, color=c, rotate=0]{0.9};
\draw [anchor= west] (18.1,11.8659) node[scale=1.52731, color=c, rotate=0]{1};
\draw [anchor= east] (19.6,11.8659) node[scale=1.52731, color=c, rotate=90]{ Acceptance};
\definecolor{c}{rgb}{1,1,1};
\draw [color=c, fill=c] (2,12.8206) rectangle (18,13.5708);
\definecolor{c}{rgb}{0,0,0};
%\draw (10,13.1957) node[scale=1.40004, color=c, rotate=0]{ND acceptance for ND-LAr events};
\end{tikzpicture}
