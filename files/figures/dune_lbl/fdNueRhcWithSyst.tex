...
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (10.8023,9.93243) node[scale=2.6728, color=c, rotate=0]{NH, $\dcp = \frac{\pi}{2}$};
\draw [c,line width=1.8] (8.90258,10.2913) -- (10.467,10.2913);
\draw [anchor=base west] (10.8023,8.33739) node[scale=2.6728, color=c, rotate=0]{IH, $\dcp = \frac{\pi}{2}$};
\draw [c,dash pattern=on 2.40pt off 2.40pt ,line width=1.8] (8.90258,8.69627) -- (10.467,8.69627);
\draw [anchor=base west] (10.8023,6.74236) node[scale=2.6728, color=c, rotate=0]{NH, $\dcp = \pi$};
