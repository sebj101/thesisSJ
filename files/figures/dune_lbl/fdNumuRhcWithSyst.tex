...
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (8.82522,9.85673) node[scale=3.43646, color=c, rotate=0]{$\theta_{23} = 49.6$};
\draw [c,line width=1.8] (7.04728,10.3725) -- (8.51146,10.3725);
\draw [anchor=base west] (8.82522,7.56447) node[scale=3.43646, color=c, rotate=0]{$\theta_{23} = 40.4$};
