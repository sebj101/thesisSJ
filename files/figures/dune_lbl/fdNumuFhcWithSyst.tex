...
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (9.55587,9.54513) node[scale=3.11827, color=c, rotate=0]{$\theta_{23} = 49.6$};
\draw [c,line width=1.8] (7.91189,10.1576) -- (9.26576,10.1576);
\draw [anchor=base west] (9.55587,6.82307) node[scale=3.11827, color=c, rotate=0]{$\theta_{23} = 40.4$};
