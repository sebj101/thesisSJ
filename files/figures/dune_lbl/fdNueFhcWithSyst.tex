...
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (10.8166,10.0993) node[scale=2.86371, color=c, rotate=0]{NH, $\dcp = \frac{\pi}{2}$};
\draw [c,line width=1.8] (8.95344,10.4776) -- (10.4878,10.4776);
\draw [anchor=base west] (10.8166,8.41834) node[scale=2.86371, color=c, rotate=0]{IH, $\dcp = \frac{\pi}{2}$};
\draw [c,dash pattern=on 2.40pt off 2.40pt ,line width=1.8] (8.95344,8.79656) -- (10.4878,8.79656);
\draw [anchor=base west] (10.8166,6.73734) node[scale=2.86371, color=c, rotate=0]{NH, $\dcp = \pi$};
