...
One can visualise the effect of this equation graphically as is shown in Figure~\ref{fig:twoNeutrino}, left and right. 
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \end{adjustbox}
  \end{minipage}
  \caption{Left: Probability of detecting an initial $\nu_{\alpha}$ as a particular flavour as a function of baseline, $L$. Here, the energy of the neutrino is 1~GeV. Right: Probability of detecting an initial $\nu_{\alpha}$ as a particular flavour as a function of neutrino energy at a fixed baseline.}
