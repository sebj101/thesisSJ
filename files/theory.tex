...
\begin{figure}[h]
  ...
  \caption[Limits from the T2K experiment on various neutrino oscillation parameters]{Limits from the T2K experiment on various neutrino oscillation parameters}
  \label{fig:t2kLimits}
\end{figure}
