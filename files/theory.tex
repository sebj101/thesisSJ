...
As a result, electron neutrinos experience an additional potential, $V_{e} = \sqrt{2} G_{F} N_{e}$, where $G_{F}$ is the Fermi constant, $N_{e}$ is the electron density of the medium.
...
\begin{table}
  ...
  \begin{tabular}{c c}
    ...
    $\frac{\deltami{31}}{10^{-3}~\text{eV}^{2}}$ & $+2.525^{+0.033}_{-0.032}$ ($-2.438^{+0.034}_{-0.032}$) \\[.2cm]
    $\frac{\deltami{32}}{10^{-3}~\text{eV}^{2}}$ & $+2.451^{+0.033}_{-0.032}$ ($-2.512^{+0.034}_{-0.032}$) \\[.2cm]
    \hline
    \hline
    ...
    \hline
    $\frac{\deltami{21}}{10^{-5}~\text{eV}^{2}}$ & $7.39^{+0.21}_{-0.20}$ \\[.2cm]
    $\frac{\deltami{31}}{10^{-3}~\text{eV}^{2}}$ & $+2.525^{+0.033}_{-0.031}$ ($-2.438^{+0.034}_{-0.031}$) \\[.2cm]
    $\frac{\deltami{32}}{10^{-3}~\text{eV}^{2}}$ & $+2.451^{+0.033}_{-0.031}$ ($-2.512^{+0.034}_{-0.031}$) \\[.2cm]
    \hline
  \end{tabular}
\end{table}
...
Therefore, in order to attain a $5\sigma$ measurement of \dcp, the next generation of oscillation experiments will be required.
...
\begin{figure}[h]
	...
	\begin{minipage}[t]{.49\linewidth}
		\centering
		\includegraphics[width=.8\linewidth]{files/figures/theory/novaLimits}
	\end{minipage}
