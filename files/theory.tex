...
This leads to an oscillation probability of the same form as Eq.~\ref{eq:twoNuProb}
\begin{equation}
...
One can infer several interesting points from Equations~\ref{eq:mswMass} and~\ref{eq:mswAngle}.
...
A graphical representation of these equations for multiple different values of \dcp is shown in Figure~\ref{fig:threeNuApp}.
