...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{.49\textwidth}
    ...
    \feynmandiagram [vertical=a to b] {
      ...
      f1 [particle=\nul] -- [anti fermion] b -- [anti fermion] f2 [particle=\(l^{-}\)]
    };
  ...
  \begin{subfigure}[t]{.49\textwidth}
    ...
    \feynmandiagram [vertical=a to b] {
      ...
      f1 [particle=\(l^{-}\)]  -- [anti fermion] b -- [anti fermion] f2 [particle=\(l^{-}\)]
    };    
...
Unlike the other fermions it is possible that neutrinos may be their own antiparticles.
