...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption[Examples of diagrams for charged (CC) and neutral (NC) current neutrino interactions.]{Examples of diagrams for charged (CC) and neutral (NC) current neutrino interactions.}
  \label{fig:nuIntEx}
\end{figure}
