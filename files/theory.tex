...
The reason for the omission is the existence of the Mikheyev-Smirnov-Wolfenstein (MSW) effect which affects neutrino oscillations when passing through media.
