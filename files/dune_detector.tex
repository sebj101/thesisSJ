...
\begin{table}
  \caption{Basic parameters for a DUNE dual-phase module from~\cite{idrVol3}.}
  \label{tab:dpStats}
  \centering
  \begin{tabular}{c c}
    \hline
...
\begin{figure}[h]
  ...
  \caption{Cut away diagram of a DUNE dual-phase far detector module from~\cite{idrVol3}. The image clearly shows the placement of the anode, cathode and PMTs.}
...
In the most na\"ive case we can measure the electron neutrino probability via
\begin{equation}
...
\begin{figure}[h]
  ...
  \caption{Diagram of the DUNE near detector. In this view, the neutrino beam enters from the right of the picture.}
  \label{fig:ndDiag}
\end{figure}
