...
If it is proven that $\dcp \neq 0$ or $\pi$, this would be proof of the existence of CP-violation in the lepton sector.
...
\end{align}
which other experiments are predicted to have a lower detection efficiency~\cite{duneBSM}.
