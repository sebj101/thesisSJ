...
It seems that at least one of these modules will use dual-phase LArTPC technology while the others will use single-phase LArTPC technology.
...
He proposed a cylindrical volume of gas (in the report the suggested gas is methane) with parallel electric and magnetic fields along the axis of the cylinder.
...
An diagram of this proposal is shown in \citefig{fig:tpcRubbia}.

\begin{figure}[h]
  \centering
  \includegraphics[width=.7\linewidth]{files/figures/dune_detector/tpcRubbia}
  \caption{Diagram of Rubbia's proposed time projection chamber from~\cite{rubbiaProp}.}
  \label{fig:tpcRubbia}
\end{figure}
