...
\num{1.1d21} protons will be delivered to the target every year, while the beam will have a planned power of \SI{1.2}{\mega\watt}~\cite{duneBeam}.

Within this target area the protons, which will have energies of up to will impinge upon the neutrino production target
