...
Two of these remaining issues are that the ordering of the neutrino mass eigenstates is not yet known and the value of $\delta_{CP}$ in the PMNS matrix remains unknown.
...
\label{sec:dune:beam:uncertainties}
