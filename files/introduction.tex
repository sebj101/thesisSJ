...
\citechap{sec:dune_ndrwt} provides an insight into how the gaseous argon component of the DUNE near detector can be used to correct for lack of knowledge about how neutrinos interact with matter in DUNE.
The analysis also provides a demonstration of how this information can be used to help DUNE meet its physics goals.

\citechap{sec:hptpc_dtof_characterisation} describes the construction and characterisation of a time of flight system while \citechap{sec:hptpc_beam_flux} gives details of an analysis involving this time of flight system which took place at CERN in 2018.
