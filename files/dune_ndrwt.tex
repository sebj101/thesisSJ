...
However, only the convolution of the neutrino flux, cross-section and detector effects is actually measured by the event rate (see \citeeq{eq:eventRateConv}).
...
Additionally, GENIE uses the INTRANUKE-hA model~\cite{intranuke} to simulate final state interactions (FSI) while NuWro uses its own model of intranuclear cascades~\cite{nuwroCascade}.
