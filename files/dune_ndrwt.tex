...
%% NEEDS TO BE CHANGED THESE ARE THE TRUE DISTRIBUTIONS
\begin{figure}[t]
	...
	\begin{subfigure}[t]{.5\linewidth}
		...
		\caption{$>2\pi$}
	\end{subfigure}
	\caption[Two dimensional distributions of $E_{\text{vis}}$ and $p_{\text{vis}}$ in ND-GAr]{Two dimensional distributions of reconstructed $E_{\text{vis}}$ and $p_{\text{vis}}$ in ND-GAr, separated out by pion multiplicity.}
	\label{fig:q0q3Genie}
\end{figure}
