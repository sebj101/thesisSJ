...
\citefig{fig:dqdxPeak2} shows the reason for excluding values of \tdrift above \SI{1.5}{\ms}.
Both the runs shown in this figure appear to have very long electron lifetimes and thus see very little change in the value of \dqdxMPV over the drift distance.
