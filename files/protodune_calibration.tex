...
In order to assess if the introduction of this bias has any effect on the measurement of the oscillation parameters, \textbf{SOME NUMBER OF} FD-only fits are performed.
...
\begin{table}
	...
	\begin{tabular}{c c}
		...
		\deltami{32} & \SIrange{2.427}{2.625}{\eV\squared} \\
		\dcp & $0 - 2\pi$ \\
...
A penalty term is included which provides a constraint on the values of \thetai{13} and $\rho$.