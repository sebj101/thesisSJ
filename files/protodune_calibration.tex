...
The ProtoDUNE-SP detector, as a prototype of a single-phase DUNE FD modules provides an excellent opportunity to validate some of these systematics.
...
The average energy loss is calculated here using the `Bethe-Bloch' formula~\cite{pdg2018} which gives the energy energy loss for a particle of charge $z$, mass $M$ and with a speed $v$ such that $\beta = v / c$ and $\gamma = 1 / \sqrt{1 - \beta^{2}}$:
\begin{equation}
