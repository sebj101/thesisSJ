...
\citechap{sec:dune_lbl} expanded on the theme further by first giving an explanation of the systematic uncertainties used to calculate the sensitivities of DUNE. 
...
In order to understand DUNE's capabilities and limitations, some degree of prototyping is required.
