...
%%% Results from each of the chapters
The theory of neutrino oscillations was laid out in \citechap{sec:theory}. 
...
This time of flight system was then used in the analysis detailed in \citesec{sec:hptpc_beam_flux}.
