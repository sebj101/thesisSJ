...
This time of flight system was used to identify particle species in a beam test at CERN in 2018.
Further details of this beam test are given in \citesec{sec:hptpc_beam_flux}.
\citesec{sec:hptpc_dtof_characterisation:dtof} describes the DToF while \citesec{sec:hptpc_dtof_characterisation:characterisation} describes the characterisation of the PMTs and bars.
...
The vertical position of a particle striking the DToF can be measured by observing in which bar a signal is seen.
