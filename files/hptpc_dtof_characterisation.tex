...
The population close to 0 in \citefig{fig:N_se} is caused by the oscilloscope triggering on noise rather than signals produced by photoelectrons.
...
\citefig{fig:gainEx} shows that the gain function has a high value of $\chisquare / \text{n.d.f.}$ indicating a poor fit.
