...
An example time of flight spectrum is shown in \citefig{fig:s3Tof}.
...
This is done by shifting the value of $t_{f}-t_{i}$ such that 
This procedure is repeated for both ToF DAQs.
