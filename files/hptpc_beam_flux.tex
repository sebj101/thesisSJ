...
The relationship between the number of $\SOne-\STwo$ hits for various numbers of moderator blocks is shown in \citefig{fig:s1s2DeadtimeComp}.
...
\begin{figure}[t]
  ...
  \caption[Comparison of $\SOne-\STwo$ hits in the two ToF DAQs]{Comparison of $\SOne-\STwo$ hits in the two ToF DAQs with a first-order polynomial fitted in each case.}
\end{figure}
