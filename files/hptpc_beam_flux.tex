...
\begin{itemize}
    ...
    \item \SThree, a panel of plastic scintillator bars placed directly upstream of the TPC vessel, described in \citesec{sec:hptpc_beam_flux:overview:s3};
    \item \SFour, a panel of plastic scintillator bars placed directly downstream of the HPgTPC, which is described in \citesec{sec:hptpc_dtof_characterisation:dtof} and \citesec{sec:hptpc_beam_flux:overview:s4}.
\end{itemize}
