...
In this case, the protons already have $\beta\gamma < 3$ and looking at \citefig{fig:energyLoss} one can see that as $\beta\gamma$ falls further the energy loss and thus the amplitude will also rise.
