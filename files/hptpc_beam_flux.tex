...
As mentioned in \citesec{sec:theory:currentState}, the targets of the next generation of long baseline neutrino oscillation experiments include the measurement of non-zero \dcp and the determination of the neutrino mass hierarchy.
...
In this chapter a novel method has been demonstrated for producing a low energy flux of protons from the CERN T10 beam line.
This method consists of moderating the original beam and placing the desired target (the HPTPC prototype) at an off-axis location.

The effectiveness of this method is evaluated using two time of flight systems which measured the proton and MIP content as a function of angle as well as the energy of protons. 
