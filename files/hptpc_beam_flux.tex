...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{.5\textwidth}
    ...
    \end{adjustbox}
  \end{minipage}
  \caption[\SFour particle rates as a function of $\theta$ and moderator blocks]{Left: Right: }
  \label{fig:s4Rates}
\end{figure}
...
\begin{figure}[h]
  ...
  \end{adjustbox}
  \caption[Comparison of simulated and measure proton time of flight from \STwo to \SFour]{Comparison of simulated and measure proton time of flight from \STwo to \SFour. The data are shown as points while the simulation results are shown as solid lines.}
  \label{fig:tofS4Sim}
\end{figure}
